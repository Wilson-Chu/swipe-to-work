  ...
  return (
    (props.jobs.length > 0 && (
      <>
        ...
        {!props.loading &&
        props.jobs.length > 0 &&
        props.jobIndex < props.jobs.length ? (
          <div
          ...
          <h2 className="no-more-jobs-text">
            ...
            Change your preferences and try again!
          </h2>
        )}
      </>
    )) ||
    (props.jobs.length === 0 && (
      <>
        ...
        {!props.loading && (
          <h2 className="try-again-text">
            Oops, we couldn't find any jobs that match your set of preferences,
            <br />
