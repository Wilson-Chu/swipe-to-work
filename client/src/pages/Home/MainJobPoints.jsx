...
const MainJobPoints = function (props) {
  ...
  return props.jobs.length > 0 && (
    <div className='main-points-container'>
      {props.jobs[props.jobIndex].employer_logo && <div><img className="main-image" src={props.jobs[props.jobIndex].employer_logo} alt="employer logo" onClick={() => props.openModal()} onError={handleImageError} /></div>}
      {!props.jobs[props.jobIndex].employer_logo && <div><img className="main-image" src="https://redlakejobs.ca/wp-content/uploads/2020/10/employment.jpg" alt="jobs" onClick={() => props.openModal()} /></div>}
      <div className='main-points-text-container'>
        <h2>
          {props.jobs[props.jobIndex].job_title}
        </h2>
